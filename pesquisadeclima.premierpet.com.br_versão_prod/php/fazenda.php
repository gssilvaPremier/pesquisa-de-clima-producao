<?php
    ...
    $rB1 = "O plano de sa&uacute;de atende as minhas necessiadades e da minha fam&iacute;lia.";
    ...
    $rs = $db->sel("SELECT seguranca_trabalho, ti, home_office FROM granfood_setor WHERE id = " . intval($_SESSION['fazenda_setor']) .";");
    $db = NULL;
...
<nav class="navbar navbar-default" style="margin-top: -40px;">
    <div class="container" style="margin-top:5px; margin-bottom:10px; line-height:20px;">
        <div class="row">
            <div class="col-xs-12 col-md-8 col-lg-8"> <img src="<?php echo URL; ?>img/logo_granfood.png" class="img-responsive pull-left" style="max-height:100px; margin-top:0px;" /> </div>
            <div class="col-xs-12 col-md-4 col-lg-4"> <img src="<?php echo URL; ?>img/logo_clima.png" class="img-responsive pull-right" style="max-height:80px; margin-top:10px;" /> </div>
        </div>
    </div>
</nav>
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            <ol class="breadcrumb">
                <li><a href="javascript:void(0)">Fazenda</a></li>
                <li><a href="javascript:void(0)">Setor</a></li>
                <li class="active">Pesquisa Fazenda</li>
            </ol>
        </div>
    </div>
</div>
<form action="xhr/fazenda.php" id="form">
        ...
        <div class="row desativartudoa">
                ...
                <div class="panel panel-default">
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="left">3 - A empresa faz voc&ecirc; se sentir importante no que faz.</td>
                            ...
                            <tr>
                                <td align="left">4 - Os processos, procedimentos e rotinas de trabalho da empresa s&atilde;o organizados e eficientes.</td>
                            ...
                            <tr>
                                <td align="left">5 - Tenho confian&ccedil;a no Futuro da empresa.</td>
                            ...
                            <tr>
                                <td align="left">6 - Tenho orgulho e gosto de trabalhar na empresa.</td>
                            ...
                            <tr>
                                <td align="left">7 - Seus colegas de trabalho se sentem compromissados em, juntos desempenharem um trabalho com qualidade.</td>
                            ...
                            <tr>
                                <td align="left">8 - Os objetivos da empresa s&atilde;o claros e divulgados a todos os colaboradores.</td>
                            ...
                            <tr>
                                <td align="left">9 - A empresa ouve e coloca em pr&aacute;tica as sugest&otilde;es de seus colaboradores.</td>
                            ...
                            <tr>
                                <td align="left">10 - Do ano passado para c&aacute; a empresa melhorou.</td>
                    ...
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr id="beneficio_golden">
                                <td align="left">6 - O benefício da Golden Farma, atende as minhas necessidades.</td>
                                <td align="center"><input type="radio" required name="beneficio8" id="beneficio8" value="1" /></td>
                                <td align="center"><input type="radio" required name="beneficio8" id="beneficio8" value="2" /></td>
                                <td align="center"><input type="radio" required name="beneficio8" id="beneficio8" value="3" /></td>
                                <td align="center"><input type="radio" required name="beneficio8" id="beneficio8" value="4" /></td>
                            </tr>
                            <tr>
                                <td align="left"><strong>Justifique todas as respostas em que voc&ecirc; assinalou discordo totalmente ou parcialmente:</strong></td>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td align="left">1 - A cesta b&aacute;scia da GrandFood atende as minhas necessidades?</td>
                        ...
                        <tr>
                            <td colspan="5">
                                <span class="text-primary">2 - Utilizo o conv&ecirc;nio com as farmacias da cidade?</span>
                                <input type="radio" name="outros_farmacia"  onclick="showDiv('outros_farmacia',1)" required="required" value="1"> Sim
                                <input type="radio" name="outros_farmacia"  onclick="showDiv('outros_farmacia',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
                        <tr id="outros_farmacia">
                            <td align="left">O conv&ecirc;nio com as farmacias da cidade atende as minhas necessidades</td>
                        ...
                        <tr>
                            <td colspan="5">
                                <span class="text-primary">5 - Tem filhos at&eacute; 10 anos e recebe os brinquedos no final do ano?</span>
                                <input type="radio" name="outros_brinquedos" onclick="showDiv('outros_brinquedos',1)" required="required" value="1"> Sim
                                <input type="radio" name="outros_brinquedos" onclick="showDiv('outros_brinquedos',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
                        <tr id="outros_brinquedos">
                        ...
                        <tr>
                            <td colspan="5">
                                <span class="text-primary">6 - Tem filhos de 3 a 10 anos e recebe o aux&iacute;lio material escolar no final do ano?</span>
                                <input type="radio" name="outros_material" onclick="showDiv('outros_material',1)" required="required" value="1"> Sim
                                <input type="radio" name="outros_material" onclick="showDiv('outros_material',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
                        <tr id="outros_material">
                        ...
                        <tr>
                            <td colspan="5">
                                <span class="text-primary">7 - Voc&ecirc; possui o plano de previd&ecirc;ncia privada da empresa?</span>
                                <input type="radio" name="outros7_div" onclick="showDiv('outros7_div',1)" required="required" value="1"> Sim
                                <input type="radio" name="outros7_div" onclick="showDiv('outros7_div',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="5">
                                <span class="text-primary">8 - Voc&ecirc; se sentiu amparado pela empresa at&eacute; este momento da pandemia da COVID-19?</span>
                                <input type="radio" name="outros8_div" onclick="showDiv('outros8_div',1)" required="required" value="1"> Sim
                                <input type="radio" name="outros8_div" onclick="showDiv('outros8_div',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
