<nav class="navbar navbar-default" style="margin-top: -40px;">
    ...
    <div class="row">
      <div class="col-xs-12 col-md-8 col-lg-8">
      		<img src="<?php echo URL; ?>img/logo_progato.png" class="img-responsive pull-left" style="max-height:50px; margin-top:25px;" />
      </div>
...
<div class="container">
  <form action="" class="form-signin" method="post">
    <h2 class="form-signin-heading">Progato</h2>
	...
	if(isset($_POST['setor'])) {
        ...
        //     echo '</style>';
        $_SESSION['progato_setor'] = $_POST['setor'];
			header("Location: ./");
	...
	$rs = $db->sel("SELECT * FROM progato_setor ORDER BY nome ASC; ");
	$db = NULL;
