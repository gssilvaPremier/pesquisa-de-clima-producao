    ...
    <div class="container" style="margin-top:5px; margin-bottom:10px; line-height:20px;">
        <div class="row">
            <div class="col-xs-12 col-md-8 col-lg-8">
                <img src="<?php echo URL; ?>img/logo_brascorp.png" class="img-responsive pull-left" style="max-height:100px; margin-top:0px;" />
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            <ol class="breadcrumb">
                <li><a href="javascript:void(0)">Brascorp</a></li>
                <li class="active">Pesquisa Brascorp</li>
            </ol>
        </div>
    </div>
</div>

<form action="xhr/brascorp.php" id="form">
                ...
                <div class="panel panel-default">
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary">3 - Voc&ecirc; utiliza o vale transporte oferecido pela empresa?</span>
                            ...
                            <tr id="beneficio_transporte">
                                <td align="left">O vale transporte atende as minhas necessidades.</td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary">4 - Voc&ecirc; utiliza o vale refei&ccedil;&atilde;o oferecido pela empresa?</span>
                            ...
                            <tr id="beneficio_vr">
                                <td align="left">O vale refei&ccedil;&atilde;o atende as minhas necessidades.</td>
                            ...
                            <tr id="beneficio_golden">
                                <td align="left">7 - O benefício da Golden Farma, atende as minhas necessidades.</td>
