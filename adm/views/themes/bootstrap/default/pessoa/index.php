    ...
    <!-- Form -->
      ...
      <form method="post" action="<?php echo URL . $pagina; ?>">
        <div class="col-xs-12 col-md-4 col-lg-3 form-group">
         ...
         <div class="col-xs-12 col-md-4 col-lg-2 form-group" >
          <label for="login">Assistencial 7</label>    
            <?php echo Func::comboTurma($this->singleUser['idtipo_assistencial7'], "idtipo_assistencial7", true, $this->instanceDB, " AND idtipo_assistencial = 7", false, false); ?>
         </div>
         <div class="col-xs-12 col-md-4 col-lg-2 form-group" >
          <label for="login">Assistencial 8</label>    
            <?php echo Func::comboTurma($this->singleUser['idtipo_assistencial8'], "idtipo_assistencial8", true, $this->instanceDB, " AND idtipo_assistencial = 8", false, false); ?>
         </div>
         <div class="col-xs-12 col-md-4 col-lg-2 form-group" >
          <label for="login">Assistencial 9</label>    
            <?php echo Func::comboTurma($this->singleUser['idtipo_assistencial9'], "idtipo_assistencial9", true, $this->instanceDB, " AND idtipo_assistencial = 9", false, false); ?>
         </div>
