...
<?php
    ...
    $rs = $db->sel("SELECT seguranca_trabalho, ti, home_office, ci, beneficios FROM premier_setor WHERE id = " . (int) $_SESSION['premier_setor'] . ";");
    $db = NULL;

     if(intval($_SESSION['premier_setor_um']) == 1){ //PREMIER DOURADO
    
       $pB1 = "1 - Voc&ecirc; possui o plano de sa&uacute;de da empresa?";
       $rB1 = "O plano de sa&uacute;de atende as minhas necessidades e da minha fam&iacute;lia.";
       $pB2 = "2 - Voc&ecirc; possui o plano odontol&oacute;gico da empresa?";
       $rB2 = "O plano odontol&oacute;gico atende as minhas necessidades e da minha fam&iacute;lia.";
       $pB3 = "3 - Voc&ecirc; utiliza o transporte oferecido pela empresa (Fretado)?";
       $rB3 = "O transporte atende as necessidades dos colaboradores.";
       $pB4 = "4 - Voc&ecirc; utiliza o servi&ccedil;o de restaurante oferecido pela empresa?";
       $rB4 = "O servi&ccedil;o do restaurante atende as necessidades dos colaboradores.";
       ...
       $pB2 = "2 - Voc&ecirc; possui o plano odontol&oacute;gico da empresa?";
       $rB2 = "O plano odontol&oacute;gico atende as minhas necessidades e da minha fam&iacute;lia.";
       $pB3 = "3 - Voc&ecirc; utiliza o vale transporte oferecido pela empresa?";
       $rB3 = "O vale transporte atende as minhas necessidades.";
       $pB4 = "4 - Voc&ecirc; utiliza o vale refei&ccedil;&atilde;o oferecido pela empresa?";
       $rB4 = "O vale refei&ccedil;&atilde;o atende as minhas necessidades.";
    
     }
    
    ?>
<form action="xhr/premier.php" id="form">
    <div class="container"  style="margin-bottom:50px;">
        <div class="row desativartudoa">
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <?php if(intval($_SESSION['premier_setor_um']) == 5){ // FABRICA PARANA ?>
                    ...
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5"><span class="text-primary">1 - Voc&#234; possui o plano de sa&uacute;de da empresa? </span> <input type="radio" name="beneficio_convenio_medico" onclick="showDiv('beneficio_convenio_medico',1)" required="required" value="1"> Sim <input type="radio" name="beneficio_convenio_medico" onclick="showDiv('beneficio_convenio_medico',0)" required="required" value="0"> N&atilde;o
                                </td>
                            </tr>
                            <tr id="beneficio_convenio_medico">
                                <td align="left">O plano de saúde atende as minhas necessidades e da minha família.</td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary">2 - Voc&#234; utiliza o transporte oferecido pela empresa (Fretado)?</span>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary">3 - Voc&ecirc; utiliza o servi&ccedil;o de restaurante oferecido pela empresa?</span>
                            ...
                            <tr id="beneficio_transporte">
                              ...
                              <tr>
                                <td align="left">4 - Estou satisfeito com as campanhas como: Dia das M&atilde;es, Dia dos Pais, Final de Ano e outras.</td>
                                <td align="center"><input type="radio" required name="beneficio4" id="beneficio4" value="1" /></td>
                                <td align="center"><input type="radio" required name="beneficio4" id="beneficio4" value="2" /></td>
                                <td align="center"><input type="radio" required name="beneficio4" id="beneficio4" value="3" /></td>
                                <td align="center"><input type="radio" required name="beneficio4" id="beneficio4" value="4" /></td>                                
                            </tr>
                            <tr>
                                <td align="left">5 - Estou satisfeito com o  resultado do PPR - Programa de Participa&ccedil;&atilde;o nos Resultados.</td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary">6 - Você utiliza o cartão da Golden Farma?</span>
                ...
                <?php } else { ?>
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5"><span class="text-primary"><?php echo $pB1; ?></span> <input type="radio" name="beneficio_convenio_medico" onclick="showDiv('beneficio_convenio_medico',1)" required="required" value="1"> Sim <input type="radio" name="beneficio_convenio_medico" onclick="showDiv('beneficio_convenio_medico',0)" required="required" value="0"> N&atilde;o
                                </td>
                            </tr>
                            <tr id="beneficio_convenio_medico">
                                <td align="left"><?php echo $rB1; ?></td>
                                <td align="center"><input type="radio" name="beneficio1" id="beneficio1" value="1" /></td>
                                <td align="center"><input type="radio" name="beneficio1" id="beneficio1" value="2" /></td>
                                <td align="center"><input type="radio" name="beneficio1" id="beneficio1" value="3" /></td>
                                <td align="center"><input type="radio" name="beneficio1" id="beneficio1" value="4" /></td>                                
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary"><?php echo $pB2; ?></span>
                                    <input type="radio" name="beneficio_odontologico"  onclick="showDiv('beneficio_odontologico',1)" required="required" value="1"> Sim
                                    <input type="radio" name="beneficio_odontologico"  onclick="showDiv('beneficio_odontologico',0)" required="required" value="0"> N&atilde;o
                                </td>
                            </tr>
                            <tr id="beneficio_odontologico">
                                <td align="left"><?php echo $rB2; ?></td>
                                <td align="center"><input type="radio" name="beneficio2" id="beneficio2" value="1" /></td>
                                <td align="center"><input type="radio" name="beneficio2" id="beneficio2" value="2" /></td>
                                <td align="center"><input type="radio" name="beneficio2" id="beneficio2" value="3" /></td>
                                <td align="center"><input type="radio" name="beneficio2" id="beneficio2" value="4" /></td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary"><?php echo $pB3; ?></span>
                                    <input type="radio" name="beneficio_transporte" onclick="showDiv('beneficio_transporte',1)" required="required" value="1"> Sim <input type="radio" name="beneficio_transporte" onclick="showDiv('beneficio_transporte',0)" required="required" value="0"> N&atilde;o
                                </td>
                            </tr>
                            <tr id="beneficio_transporte">
                                <td align="left"><?php echo $rB3; ?></td>
                                <td align="center"><input type="radio" name="beneficio3" id="beneficio3" value="1" /></td>
                                <td align="center"><input type="radio" name="beneficio3" id="beneficio3" value="2" /></td>
                                <td align="center"><input type="radio" name="beneficio3" id="beneficio3" value="3" /></td>
                                <td align="center"><input type="radio" name="beneficio3" id="beneficio3" value="4" /></td>
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary"><?php echo $pB4; ?></span>
                            ...
                            <tr>
                                <td align="left">5 - Estou satisfeito com as campanhas como: Dia das M&atilde;es, Dia dos Pais, Final de Ano e outras.</td>
                                <td align="center"><input type="radio" required name="beneficio5" id="beneficio5" value="1" /></td>
                                <td align="center"><input type="radio" required name="beneficio5" id="beneficio5" value="2" /></td>
                                <td align="center"><input type="radio" required name="beneficio5" id="beneficio5" value="3" /></td>
                                <td align="center"><input type="radio" required name="beneficio5" id="beneficio5" value="4" /></td>                                
                            ...
                            <tr>
                                <td colspan="5">
                                    <span class="text-primary">7 - Você utiliza o cartão da Golden Farma?</span>
                                    <input type="radio" name="beneficio_golden" onclick="showDiv('beneficio_golden',1)" required="required" value="1"> Sim
                                    <input type="radio" name="beneficio_golden" onclick="showDiv('beneficio_golden',0)" required="required" value="0"> N&atilde;o
                                </td>
                            </tr>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped" id="seguranca_trabalho">
                        ...
                        <tbody>
                            <tr>
                                <td align="left">Existe uma orienta&ccedil;&atilde;o da equipe de seguran&ccedil;a do trabalho sobre a utiliza&ccedil;&atilde;o de EPI's.</td>
                            ...
                            <tr>
                                <td align="left">A seguran&ccedil;a do trabalho realiza um trabalho de qualidade .</td>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped" id="tecnologia_informacao">
                        ...
                        <tbody>
                            <tr>
                                <td align="left">O departamento de TI cumpre os prazos de atendimento aos colaboradores.</td>
                            ...
                            <tr>
                                <td align="left">Os sistemas utilizados na empresa atendem as necessidades gerais.</td>
                            ...
                            <tr>
                                <td align="left">O departamento de TI realiza um trabalho de qualidade.</td>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td align="left" colspan="4">Coment&aacute;rios gerais:</td>
                            </tr>
                            <tr>
            ...
            <?php 
                //print_r($_SESSION);
                ?>
            <?php if($_SESSION['premier_setor_um'] == 5) { //F&aacute;brica Paran&aacute;
                $_SESSION['empresa'] = 11; ?>
			<?php if(1==2) { ?>	
            <div class="col-xs-12 col-md-12 col-lg-12">
                <h3>Outros</h3>
                <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="5"><span class="text-primary">1 - Voc&ecirc; utiliza o vale alimenta&ccedil;&atilde;o oferecido pela empresa?</span> <input type="radio" name="outros1_div" onclick="showDiv('outros1_div',1)" required="required" value="1"> Sim <input type="radio" name="outros1_div" onclick="showDiv('outros1_div',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
                        <tr id="outros1_div" class="esconde">
                            <td align="left">O vale alimenta&ccedil;&atilde;o atende as minhas necessidades.</td>
                        ...
                        <tr>
                            <td colspan="5"><span class="text-primary">2 - Voc&ecirc; se sentiu amparado pela empresa at&eacute; este momento da pandemia da COVID-19?</span> <input type="radio" name="outros2_div" onclick="showDiv('outros2_div',1)" required="required" value="1"> Sim <input type="radio" name="outros2_div" onclick="showDiv('outros2_div',0)" required="required" value="0"> N&atilde;o
                            </td>
                        </tr>
                        <tr id="outros2_div" class="esconde">
		...
		<?php } ?>
        <?php } else if($_SESSION['premier_setor_um'] == 0) { //Escrit&oacute;rio SP
            $_SESSION['empresa'] = 6; ?>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            ...
            <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="5"><span class="text-primary">3 - Tem filhos at&eacute; 10 anos e recebe os brinquedos no final do ano?</span> <input type="radio" name="outros3_div" onclick="showDiv('outros3_div',1)" required="required" value="1"> Sim <input type="radio" name="outros3_div" onclick="showDiv('outros3_div',0)" required="required" value="0"> N&atilde;o
                        </td>
                    </tr>
                    <tr id="outros3_div" class="esconde">
	...
	<?php } ?>
    <?php } elseif($_SESSION['premier_setor_um'] == 2 || $_SESSION['premier_setor_um'] == 3 || $_SESSION['premier_setor_um'] == 4){ //CD'S E EXTERNOS OU Esc. Rondon&oacute;polis
        if($_SESSION['premier_setor_um'] == 2){
            $_SESSION['empresa'] = 7;
        } else if($_SESSION['premier_setor_um'] == 4) {
            $_SESSION['empresa'] = 9;
        } else {
          $_SESSION['empresa'] = 10;
        } ?>
    ...
    <div class="col-xs-12 col-md-12 col-lg-12">
        ...
        <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
            ...
            <tbody>
                <tr>
                    <td align="left">1 - O cart&atilde;o de Natal &eacute; &oacute;timo, e atende minhas necessidades.</td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="1" /></td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="2" /></td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="3" /></td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="4" /></td>                    
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">2 - Tem filhos at&eacute; 10 anos e recebe os brinquedos no final do ano?</span> <input type="radio" name="outros2_div" onclick="showDiv('outros2_div',1)" required="required" value="1"> Sim <input type="radio" name="outros2_div" onclick="showDiv('outros2_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros2_div" class="esconde">
                    <td align="left">Meus filhos adoram os brinquedos que ganham da empresa.</td>
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">3 - Tem filhos de 3 a 10 anos e recebe o aux&iacute;lio material escolar no final do ano?</span> <input type="radio" name="outros3_div" onclick="showDiv('outros3_div',1)" required="required" value="1"> Sim <input type="radio" name="outros3_div" onclick="showDiv('outros3_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros3_div" class="esconde">
                    <td align="left">O auxilio material escolar &eacute; bom e me ajuda muito com os gastos do in&iacute;cio do ano.</td>
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">4 - Voc&ecirc; possui o plano de previd&ecirc;ncia privada da empresa?</span> <input type="radio" name="outros4_div" onclick="showDiv('outros4_div',1)" required="required" value="1"> Sim <input type="radio" name="outros4_div" onclick="showDiv('outros4_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros4_div" class="esconde">
                    <td align="left">O plano de previd&ecirc;ncia privada atende as minhas expectativas</td>
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">5 - Voc&ecirc; se sentiu amparado pela empresa at&eacute; este momento da pandemia da COVID-19?</span> <input type="radio" name="outros5_div" onclick="showDiv('outros5_div',1)" required="required" value="1"> Sim <input type="radio" name="outros5_div" onclick="showDiv('outros5_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros5_div" class="esconde">
                    <td align="left">As medidas de preven&ccedil;&atilde;o da Covid 19 implantadas pela empresa, atendeu minhas expectativas.</td>
	...
	<?php } ?>
    <?php }  elseif($_SESSION['premier_setor_um'] == 1) { //Premier - Fabrica Dourado
        $_SESSION['empresa'] = 8; ?>
	<?php if(1==2) { ?>
    <div class="col-xs-12 col-md-12 col-lg-12">
        <h3>Outros</h3>
        <table class="table table-hover table-condensed table-responsive table-bordered table-striped">
            ...
            <tbody>
                <tr>
                    <td align="left">1 - A cesta b&aacute;sica da PremieRpet&reg;atende as minhas necessidades</td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="1" /></td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="2" /></td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="3" /></td>
                    <td align="center"><input type="radio" name="outros1" id="outros1" value="4" /></td>                    
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">2 - Utilizo o conv&ecirc;nio com as farm&aacute;cias da cidade?</span> <input type="radio" name="outros2_div" onclick="showDiv('outros2_div',1)" required="required" value="1"> Sim <input type="radio" name="outros2_div" onclick="showDiv('outros2_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros2_div" class="esconde">
                    <td align="left">O conv&ecirc;nio com as farm&aacute;cias da cidade atende as minhas necessidades</td>
                    <td align="center"><input type="radio" name="outros2" id="outros2" value="1" /></td>
                    <td align="center"><input type="radio" name="outros2" id="outros2" value="2" /></td>
                    <td align="center"><input type="radio" name="outros2" id="outros2" value="3" /></td>
                    <td align="center"><input type="radio" name="outros2" id="outros2" value="4" /></td>
                ...
                <tr>
                    <td align="left">3 - A Cesta de Natal seca &eacute; &oacute;tima, e atende toda minha fam&iacute;lia.</td>
                    <td align="center"><input type="radio" name="outros3" id="outros3" value="1" /></td>
                    <td align="center"><input type="radio" name="outros3" id="outros3" value="2" /></td>
                    <td align="center"><input type="radio" name="outros3" id="outros3" value="3" /></td>
                    <td align="center"><input type="radio" name="outros3" id="outros3" value="4" /></td>
                ...
                <tr>
                    <td align="left">4 - A Cesta de Natal congelada &eacute; &oacute;tima, e atende toda minha fam&iacute;lia.</td>
                    <td align="center"><input type="radio" name="outros4" id="outros4" value="1" /></td>
                    <td align="center"><input type="radio" name="outros4" id="outros4" value="2" /></td>
                    <td align="center"><input type="radio" name="outros4" id="outros4" value="3" /></td>
                    <td align="center"><input type="radio" name="outros4" id="outros4" value="4" /></td>                    
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">5 - Tem filhos at&eacute; 10 anos e recebe os brinquedos no final do ano?</span> <input type="radio" name="outros5_div" onclick="showDiv('outros5_div',1)" required="required" value="1"> Sim <input type="radio" name="outros5_div" onclick="showDiv('outros5_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros5_div" class="esconde">
                    <td align="left">Meus filhos adoram os brinquedos que ganham da empresa.</td>
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">6 - Tem filhos de 3 a 10 anos e recebe o aux&iacute;lio material escolar no final do ano?</span> <input type="radio" name="outros6_div" onclick="showDiv('outros6_div',1)" required="required" value="1"> Sim <input type="radio" name="outros6_div" onclick="showDiv('outros6_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros6_div" class="esconde">
                    <td align="left">O auxilio material escolar &eacute; bom e me ajuda muito com os gastos do in&iacute;cio do ano.</td>
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">7 - Voc&ecirc; possui o plano de previd&ecirc;ncia privada da empresa?</span> <input type="radio" name="outros7_div" onclick="showDiv('outros7_div',1)" required="required" value="1"> Sim <input type="radio" name="outros7_div" onclick="showDiv('outros7_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros7_div" class="esconde">
                    <td align="left">O plano de previd&ecirc;ncia privada atende as minhas expectativas</td>
                ...
                <tr>
                    <td colspan="5"><span class="text-primary">8 - Voc&ecirc; se sentiu amparado pela empresa at&eacute; este momento da pandemia da COVID-19?</span> <input type="radio" name="outros8_div" onclick="showDiv('outros8_div',1)" required="required" value="1"> Sim <input type="radio" name="outros8_div" onclick="showDiv('outros8_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr id="outros8_div" class="esconde">
                    <td align="left">As medidas de preven&ccedil;&atilde;o da Covid 19 implantadas pela empresa, atendeu minhas expectativas.</td>
                    <td align="center"><input type="radio" name="outros8" id="outros8" value="1" /></td>
                    <td align="center"><input type="radio" name="outros8" id="outros8" value="2" /></td>
                    <td align="center"><input type="radio" name="outros8" id="outros8" value="3" /></td>
                    <td align="center"><input type="radio" name="outros8" id="outros8" value="4" /></td>
                </tr>
                <tr>
                    <td colspan="5"><span class="text-primary">9 - Sobre os servi&ccedil;os da enfermaria: as medidas de preven&ccedil;&atilde;o adotadas deveriam continuar ap&oacute;s o t&eacute;rmino da pandemia?</span> <input type="radio" name="outros9_div" onclick="showDivClass('outros9_div',1)" required="required" value="1"> Sim <input type="radio" name="outros9_div" onclick="showDivClass('outros9_div',0)" required="required" value="0"> N&atilde;o
                    </td>
                </tr>
                <tr class="esconde outros9_div">
                    <td align="left">A aferi&ccedil;&atilde;o de temperatura corporal dos colaboradores nas entradas.</td>
                    <td align="center"><input type="radio" name="outros9a" id="outros9a" value="1" /></td>
                    <td align="center"><input type="radio" name="outros9a" id="outros9a" value="2" /></td>
                    <td align="center"><input type="radio" name="outros9a" id="outros9a" value="3" /></td>
                    <td align="center"><input type="radio" name="outros9a" id="outros9a" value="4" /></td>
                </tr>
                <tr class="esconde outros9_div">
                    <td align="left">Medi&ccedil;&atilde;o de oxigena&ccedil;&atilde;o do sangue dos colaboradores nas entradas.</td>
                    <td align="center"><input type="radio" name="outros9b" id="outros9b" value="1" /></td>
                    <td align="center"><input type="radio" name="outros9b" id="outros9b" value="2" /></td>
                    <td align="center"><input type="radio" name="outros9b" id="outros9b" value="3" /></td>
                    <td align="center"><input type="radio" name="outros9b" id="outros9b" value="4" /></td>
                </tr>
                <tr class="esconde outros9_div">
                    <td align="left">Atendimento ambulatorial: medica&ccedil;&atilde;o, aferi&ccedil;&atilde;o de press&atilde;o e socorro m&eacute;dico.</td>
                    <td align="center"><input type="radio" name="outros9c" id="outros9c" value="1" /></td>
                    <td align="center"><input type="radio" name="outros9c" id="outros9c" value="2" /></td>
                    <td align="center"><input type="radio" name="outros9c" id="outros9c" value="3" /></td>
                    <td align="center"><input type="radio" name="outros9c" id="outros9c" value="4" /></td>
                </tr>
                <tr class="esconde outros9_div">
                    <td align="left">Atendimento a acidentes: primeiros socorros, curativos e imobiliza&ccedil;&atilde;o quando necess&aacute;rio.</td>
                    <td align="center"><input type="radio" name="outros9d" id="outros9d" value="1" /></td>
                    <td align="center"><input type="radio" name="outros9d" id="outros9d" value="2" /></td>
                    <td align="center"><input type="radio" name="outros9d" id="outros9d" value="3" /></td>
                    <td align="center"><input type="radio" name="outros9d" id="outros9d" value="4" /></td>
                </tr>
                <tr>
                    <td align="left"><strong>Justifique todas as respostas em que voc&ecirc; assinalou discordo totalmente ou parcialmente:</strong></td>
                    <td colspan="4"><input type="text" class="form-control" name="outros_justificativa" id="outros_justificativa" style="width:100%;" value="" placeholder="Informe aqui sua justificativa" /></td>
