<nav class="navbar navbar-default" style="margin-top: -40px;">
    ...
    <div class="row">
      <div class="col-xs-12 col-md-8 col-lg-8">
      		<img src="<?php echo URL; ?>img/logo_granfood.png" class="img-responsive pull-left" style="max-height:100px; margin-top:0px;" />
      </div>
...
<div class="container">
  <form action="" class="form-signin" method="post">
    <h2 class="form-signin-heading">Grandfood Agricola</h2>
    <p class="text-warning">Escolha abaixo o setor no qual trabalha</p>
    <?php
	...
	if(isset($_POST['setor'])) {
		if($_POST['setor'] != "0") {
            ...
            // echo '</style>';
			$_SESSION['fazenda_setor'] = $_POST['setor'];
			header("Location: ./");

		} else {
			echo '<div class="alert alert-info" role="alert"><span class="glyphicon glyphicon-info-sign"></span> Informe um <strong>Setor</strong></div>';
		}
	}


	$db = new Conexao($banco);
	$rs = $db->sel("SELECT * FROM granfood_setor ORDER BY nome ASC;");
	$db = NULL;
